...
PyObject * chrIsPrivateShop(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsPrivateShop());
}
...
PyObject * chrIsDead(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", pInstance->IsStun());
}
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "IsPrivateShop",				chrIsPrivateShop,					METH_VARARGS },
	...
	PyObject* poModule = Py_InitModule(CPythonDynamicModule::Instance().GetModule(PYTHON_CHARACTER).c_str(), s_methods);
	...
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_CHARGING",			CRaceMotionData::NAME_CHARGING);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_NOSAY",				CRaceMotionData::NAME_NOSAY);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_WEATHER_1",			CRaceMotionData::NAME_WEATHER_1);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_WEATHER_2",			CRaceMotionData::NAME_WEATHER_2);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_WEATHER_3",			CRaceMotionData::NAME_WEATHER_3);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_HUNGRY",				CRaceMotionData::NAME_HUNGRY);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_SIREN",				CRaceMotionData::NAME_SIREN);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_LETTER",				CRaceMotionData::NAME_LETTER);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_CALL",				CRaceMotionData::NAME_CALL);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_CELEBRATION",			CRaceMotionData::NAME_CELEBRATION);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_ALCOHOL",				CRaceMotionData::NAME_ALCOHOL);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_BUSY",				CRaceMotionData::NAME_BUSY);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_WHIRL",				CRaceMotionData::NAME_WHIRL);
#endif
...
#ifdef ENABLE_EXPRESSING_EMOTION
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EMOTION",					CInstanceBase::NEW_AFFECT_EMOTION);
#endif
}
