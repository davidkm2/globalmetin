...
void CPythonSafeBox::OpenSafeBox(int iSize)
{
	...
	m_ItemInstanceVector.resize(SAFEBOX_PAGE_COLUMN * iSize);
...
void CPythonSafeBox::OpenMall(int iSize)
{
	...
	m_MallItemInstanceVector.resize(SAFEBOX_PAGE_COLUMN * iSize);
...
void initsafebox()
{
	...
	PyModule_AddIntConstant(poModule, "SAFEBOX_PAGE_COLUMN", SAFEBOX_PAGE_COLUMN);
	PyModule_AddIntConstant(poModule, "SAFEBOX_PAGE_ROW", SAFEBOX_PAGE_ROW);
	PyModule_AddIntConstant(poModule, "SAFEBOX_PAGE_SIZE", SAFEBOX_PAGE_SIZE);
	PyModule_AddIntConstant(poModule, "SAFEBOX_PAGE_COUNT", SAFEBOX_PAGE_COUNT);
