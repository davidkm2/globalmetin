...
PyObject * backgroundIsBattleFieldMap(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground& rkBG=CPythonBackground::Instance();
	return Py_BuildValue("i", rkBG.IsBattleFieldMap());
}
#endif
...
#ifdef ENABLE_BATTLE_FIELD
		{ "IsBattleFieldMap", 					backgroundIsBattleFieldMap, 				METH_VARARGS },
#endif
#ifdef ENABLE_FOG_FIX
