...
PyObject * chrmgrIsDead(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", rkChrMgr.IsDeadVID(iVid));
}

#ifdef ENABLE_AUTO_SYSTEM
PyObject * chrmgrGetVIDMax(PyObject* poSelf, PyObject* poArgs)
{
	CPythonCharacterManager & rkChrMgr = CPythonCharacterManager::Instance();

	return Py_BuildValue("i", rkChrMgr.GetVIDMax());
}

PyObject * chrmgrSetDistanceVector(PyObject* poSelf, PyObject* poArgs)
{
	CPythonCharacterManager & rkChrMgr = CPythonCharacterManager::Instance();
	rkChrMgr.SetDistanceVector();

	return Py_BuildNone();
}

PyObject * chrmgrGetDistanceVID(PyObject* poSelf, PyObject* poArgs)
{
	CPythonCharacterManager & rkChrMgr = CPythonCharacterManager::Instance();

	return Py_BuildValue("i", rkChrMgr.GetDistanceVID());
}
#endif
...
void initchrmgr()
{
...
#ifdef ENABLE_AUTO_SYSTEM
		{ "GetVIDMax",					chrmgrGetVIDMax,						METH_VARARGS },
		{ "SetDistanceVector",			chrmgrSetDistanceVector,				METH_VARARGS },
		{ "GetDistanceVID",				chrmgrGetDistanceVID,					METH_VARARGS },
#endif
		{ NULL,							NULL,									NULL },
	};

	PyObject* poModule = Py_InitModule(CPythonDynamicModule::Instance().GetModule(PYTHON_CHARACTER_MGR).c_str(), s_methods);
	...
	PyModule_AddIntConstant(poModule, "EFEKT_BOSS",				CInstanceBase::EFEKT_BOSS);
#endif
