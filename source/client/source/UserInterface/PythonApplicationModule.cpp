...
{
	int time;
	if (!PyTuple_GetInteger(poArgs, 0, &time))
		return Py_BuildException();
	char str[256];
    struct tm tm;
    time_t ct = (time_t)time;
    tm = *localtime(&ct);

    _snprintf(str, 20, "%04d-%02d-%02d %02d:%02d:%02d",
            tm.tm_year + 1900,
            tm.tm_mon + 1,
            tm.tm_mday,
            tm.tm_hour,
...
void initapp()
{
	...
	PyObject* poModule = Py_InitModule(CPythonDynamicModule::Instance().GetModule(PYTHON_APPLICATION).c_str(), s_methods);
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_BOOK_COMBINATION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_BOOK_COMBINATION", 0);
#endif
...
#ifdef ENABLE_BACKEND_LOGIN
	PyModule_AddIntConstant(poModule, "ENABLE_BACKEND_LOGIN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BACKEND_LOGIN", 0);
#endif

#ifdef ENABLE_MOVE_COSTUME_ACCE_ATTR
	PyModule_AddIntConstant(poModule, "ENABLE_MOVE_COSTUME_ACCE_ATTR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MOVE_COSTUME_ACCE_ATTR", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "SPECIAL_ACTION_START_INDEX", 61);
#else
...
#ifdef ENABLE_NOTICE_INGAME_EVENT
	PyModule_AddIntConstant(poModule, "ENABLE_NOTICE_INGAME_EVENT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NOTICE_INGAME_EVENT", 0);
#endif

#ifdef ENABLE_APPEND_PET_SKILL
	PyModule_AddIntConstant(poModule, "ENABLE_APPEND_PET_SKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_APPEND_PET_SKILL", 0);
#endif
...
#ifdef ENABLE_IMPROVE_CHARACTER_DETAIL_INFO
	PyModule_AddIntConstant(poModule, "ENABLE_IMPROVE_CHARACTER_DETAIL_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_IMPROVE_CHARACTER_DETAIL_INFO", 0);
#endif

#ifdef ENABLE_MINI_BOSS_DUNGEON
	PyModule_AddIntConstant(poModule, "ENABLE_MINI_BOSS_DUNGEON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MINI_BOSS_DUNGEON", 0);
#endif

#ifdef ENABLE_DUTCH_AUCTION_GF
	PyModule_AddIntConstant(poModule, "ENABLE_DUTCH_AUCTION_GF", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DUTCH_AUCTION_GF", 0);
#endif

#ifdef ENABLE_ITEM_SECOND_CONFIRM
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SECOND_CONFIRM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SECOND_CONFIRM", 0);
#endif
...
#ifdef ENABLE_DS_MYTH_CHANGE_ATTR
	PyModule_AddIntConstant(poModule, "ENABLE_DS_MYTH_CHANGE_ATTR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_MYTH_CHANGE_ATTR", 0);
#endif

#ifdef ENABLE_SAFE_BOX_BUFF
	PyModule_AddIntConstant(poModule, "ENABLE_SAFE_BOX_BUFF", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAFE_BOX_BUFF", 0);
#endif

#ifdef ENABLE_IMPROVE_PCT_MAKE_BELT
	PyModule_AddIntConstant(poModule, "ENABLE_IMPROVE_PCT_MAKE_BELT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_IMPROVE_PCT_MAKE_BELT", 0);
#endif

#ifdef ENABLE_REMOVE_PLAYER_CMD
	PyModule_AddIntConstant(poModule, "ENABLE_REMOVE_PLAYER_CMD", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REMOVE_PLAYER_CMD", 0);
#endif

#ifdef ENABLE_TNT
	PyModule_AddIntConstant(poModule, "ENABLE_TNT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TNT", 0);
#endif

#ifdef ENABLE_TOOLTIP_WIDTH_FIX
	PyModule_AddIntConstant(poModule, "ENABLE_TOOLTIP_WIDTH_FIX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TOOLTIP_WIDTH_FIX", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LOCALIZATION_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOCALIZATION_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_STORAGE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_STORAGE_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DS_TYPE_CHANGE",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_TYPE_CHANGE",	0);
#endif
...
#ifdef ENABLE_WEB_LINKED_BANNER_LIMIT_REMOVE
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RANKING_SYSTEM_PARTY",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RANKING_SYSTEM_PARTY",	0);
#endif
...
#ifdef ACCE_MAX_DRAINRATE
	PyModule_AddIntConstant(poModule, "ACCE_MAX_DRAINRATE",	1);
#else
	PyModule_AddIntConstant(poModule, "ACCE_MAX_DRAINRATE",	0);
#endif
...
#ifdef ENABLE_GUILDRENEWAL_SYSTEMSEARCH_MODE
	PyModule_AddIntConstant(poModule, "ENABLE_GUILDRENEWAL_SYSTEMSEARCH_MODE",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILDRENEWAL_SYSTEMSEARCH_MODE",	0);
#endif
...
#ifdef ENABLE_PRIVATESHOP_CATEGORY
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATESHOP_CATEGORY",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PRIVATESHOP_CATEGORY",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ANTICHEAT",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ANTICHEAT",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_SELL_INFO",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_SELL_INFO",	0);
#endif
}
