...
void CInstanceBase::UpdateTextTailLevel(DWORD level)
{
	...
	static D3DXCOLOR s_kPetLevelColor = D3DXCOLOR(152.0f/255.0f, 255.0f/255.0f, 51.0f/255.0f, 1.0f);
#endif
...
void CInstanceBase::__AttachEfektBoss()
{
	if (!__IsExistMainInstance())
		return;	
	...
	if (IsWarp() || IsObject() || IsFlag() || IsResource() || IsNPC() || IsStone() || IsPC() || IsWarp()
#ifdef ENABLE_GROWTH_PET_SYSTEM
|| IsNewPet()
#endif
|| IsPet()
	...
	__EffectContainer_AttachEffect(EFEKT_BOSS);
}
#endif
