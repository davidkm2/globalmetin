...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_bBattleFieldRank = src.m_bBattleFieldRank;
#endif
...
#endif
#ifdef ENABLE_BATTLE_FIELD
	kCreateData.m_bBattleFieldRank = rkNetActorData.m_bBattleFieldRank;
#endif
/*#ifdef ENABLE_ELEMENT_ADD
...
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
, c_rkNetUpdateActorData.m_dwNewIsGuildName
#endif
);
...
#endif
#ifdef ENABLE_BATTLE_FIELD
		pkInstFind->SetBattleFieldRank(c_rkNetUpdateActorData.m_bBattleFieldRank);
#endif
#ifdef ENABLE_ELEMENT_ADD
...
#endif
#ifdef ENABLE_BATTLE_FIELD
	rkNetActorData.m_bBattleFieldRank = c_rkNetUpdateActorData.m_bBattleFieldRank;
#endif
#ifdef ENABLE_ELEMENT_ADD
