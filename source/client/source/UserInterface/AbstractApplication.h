...
class IAbstractApplication : public TAbstractSingleton<IAbstractApplication>
{
	...
	public:
		...
		virtual string FindLocaleQuest(DWORD idx) = 0;
		virtual string FindLocaleString(DWORD idx) = 0;
		virtual string Convert_arg(const char * c_szFormat ...) = 0;
		virtual bool SplitLineByStr(string str, const char * c_szDelimeter, CTokenVector* pstTokenVector) = 0;
#endif
};