...
BOOL CActorInstance::isLock()
{
	...
	switch (dwCurMotionIndex)
	{
		...
		case CRaceMotionData::NAME_PUSH_UP:
		...
		case CRaceMotionData::NAME_NOSAY:
		case CRaceMotionData::NAME_WEATHER_1:
		case CRaceMotionData::NAME_WEATHER_2:
		case CRaceMotionData::NAME_WEATHER_3:
		case CRaceMotionData::NAME_HUNGRY:
		case CRaceMotionData::NAME_SIREN:
		case CRaceMotionData::NAME_LETTER:
		case CRaceMotionData::NAME_CALL:
		case CRaceMotionData::NAME_CELEBRATION:
		case CRaceMotionData::NAME_ALCOHOL:
		case CRaceMotionData::NAME_BUSY:
