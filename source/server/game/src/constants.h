...
#ifdef __MINI_GAME__
extern const DWORD dwMiniGameNpcVnums[MINIGAME_TYPE_MAX];
extern const DWORD dwMiniGameNpcPos[MINIGAME_TYPE_MAX][6];
#endif

#ifdef __12ZI__
extern const int iCzTable[2][30][2];
int GetRandomLevel(BYTE bFloor, bool bIsBoss = false);
#endif
...
extern const int aiBaseSkillPowerByLevelTable[SKILL_MAX_LEVEL + 1];
...
extern TGuildWarInfo aGuildWarInfo[GUILD_WAR_TYPE_MAX_NUM];
