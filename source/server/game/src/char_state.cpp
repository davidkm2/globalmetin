...
void CHARACTER::StateMove()
{
	...
	long long x = (long long) ((float) (m_posDest.x - m_posStart.x) * fRate + m_posStart.x);
	long long y = (long long) ((float) (m_posDest.y - m_posStart.y) * fRate + m_posStart.y);
