...
ACMD(do_battle_field_set_event);
ACMD(do_battle_field_force_close);
...
struct command_info cmd_info[] =
{
	...
	{ "aggregate",	do_aggregate,		0,			POS_DEAD,	GM_PLAYER	},
...
#ifdef __NEW_STORAGE__
    { "click_sort_special_storage_items",	do_sort_special_storage_items,	0,	POS_DEAD,	GM_PLAYER },
#endif
#endif
#ifdef __SUPPORT__
...
#endif
#ifdef __REMOTE_EXCHANGE__
	{ "remote_exchange",	do_remote_exchange,	0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef __ANCIENT_ATTRIBUTE__
	...
	{ "battle_force_close", do_battle_field_force_close, 0, POS_DEAD, GM_IMPLEMENTOR },
	{ "battle_set_event", do_battle_field_set_event, 0, POS_DEAD, GM_IMPLEMENTOR },
...
#endif
#ifdef __DAMAGE_TOP__
	{ "click_damage_top",		do_click_damage_top,		0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef __OFFLINE_PRIVATE_SHOP__
