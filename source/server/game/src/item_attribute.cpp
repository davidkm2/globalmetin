...
void CItem::AddAttribute(BYTE bApply, int sValue)
{
	if (HasAttr(bApply))
		return;
...
void CItem::SetAttribute(int i, BYTE bType, int sValue)
{
...
void CItem::SetForceAttribute(int i, BYTE bType, int sValue)
{
